...
if __name__ == "__main__":
    ...
    print("Comparing pred...")
    dd = DeepDiff(model_df.predict(X_df), model.predict(X, attrs), ignore_order=True)
    print(dd)
